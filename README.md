...
🔴 **Live:** https://joaomonteirounesp.github.io/portfolio/
...
Already live on **GitHub Pages**. For **Vercel**: import the repo at [vercel.com/new](https://vercel.com/new),
choose Framework Preset **Other** (no build needed), leave *Build Command* and *Output Directory*
blank, and click **Deploy**.
...
🔴 **No ar:** https://joaomonteirounesp.github.io/portfolio/
...
Já está no ar no **GitHub Pages**. Para o **Vercel**: importe o repositório em
[vercel.com/new](https://vercel.com/new), escolha Framework Preset **Other** (sem build),
deixe *Build Command* e *Output Directory* em branco e clique **Deploy**.

---

Feito por / Made by João Guilherme de Castro Monteiro.
